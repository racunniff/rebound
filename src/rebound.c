...
const char* reb_version_str = "3.5.12";         // **VERSIONLINE** This line gets updated automatically. Do not edit manually.
...
static void* reb_integrate_raw(void* args){
    ...
    r->status = r->start_paused ? REB_RUNNING_PAUSED : REB_RUNNING;
    reb_run_heartbeat(r);
